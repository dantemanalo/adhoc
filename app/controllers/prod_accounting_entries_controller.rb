class ProdAccountingEntriesController < ApplicationController
  ...
  def index
    @prod_accounting_entries = ProdAccountingEntry.limit(10)
  end

  # GET /prod_accounting_entries/1
  # GET /prod_accounting_entries/1.json
  def show
    @prod_accounting_entry = ProdAccountingEntry.find(params[:id])
  end

  # GET /prod_accounting_entries/new
  def new
    @prod_accounting_entry = ProdAccountingEntry.new
  end
  ...
  def create
    @prod_accounting_entry = ProdAccountingEntry.new(prod_accounting_entry_params)
